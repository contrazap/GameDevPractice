...
The 17 reference games mapped to the skills we take from them and where those are covered. Games aren't cloned; their load-bearing mechanics become features.
...
| Prince of Persia WW | Traversal/platforming, combat combos, touch-friendly controls | P3.2, P0.3 (touch) |
| Project Zomboid (3D, better coop) | Survival systems, needs, crafting, persistence, coop world state | P3.3, P3.4 |
| Don't Starve Together (3D topdown) | Survival coop, day/night cycle, harvesting | P3.4 |
| Vampire Survivors | Run-based meta progression; mass enemies at scale | P3.5, P5.1 |
| Cookie Clicker | Idle economy, big numbers, offline progress; first minigame | P2.5 |
| Flappy Bird | Minimal-scope minigame, touch input, feel tuning | P2.6 |
| Chess | Turn-based rules engine, minimax AI, board UI | P3.6 |
...
| Domain | Phases |
|---|---|
| Project/pipeline, source control, Android packaging | P0 |
...
| Genre systems (melee, inventory, survival, meta, minigames) | P3 |
| World building, vehicles, flight, procedural | P4 |
| Scale & specialty (mass entities, RTS, networked physics, server architecture) | P5 |
