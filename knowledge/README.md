...
Your personal wiki — one note per finished feature, written while it's fresh (template in [CONVENTIONS.md](../CONVENTIONS.md)). This folder exists because implementations fade from memory; the notes + the code are what you return to, and the plan generator reads them to avoid re-teaching what you already know.
